<?php
		...
		include_once 'header.php';
                ...
                if (empty($fname) || empty($lname) || empty($mobile)) {
                    ...
                    $query = "UPDATE `user` SET fname = '$fname', lname = '$lname', mobile = '$mobile' WHERE email = 'user@gmail.com'";
                    $rs = mysqli_query($conn, $query);
...
<?php
    ...
    $query = "SELECT * FROM `user` WHERE email = 'user@gmail.com'";
    $rs = mysqli_query($conn, $query);

    $data = $rs->fetch_assoc();
    $user_id = ["user_id"];

    $image_query = "SELECT * FROM `user_image` WHERE user_id ";
...
<table>
	...
	<tr>
		<td>First Name</td>
		<td>
			<input type="text" class="details" name="firstname" value="<?php echo $data["fname"]; ?>">
		</td>
	</tr>
	...
	<tr>
		<td>Last Name</td>
		<td>
			<input type="text" class="details" name="lastname" value="<?php echo $data["lname"]; ?>">
		</td>
	</tr>
